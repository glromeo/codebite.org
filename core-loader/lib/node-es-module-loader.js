(function (global, factory) {
  ...
  (factory((global.NodeESModuleLoader = global.NodeESModuleLoader || {})));
...
if (typeof document != 'undefined' && document.getElementsByTagName) {
  exports.baseURI = document.baseURI;

  if (!exports.baseURI) {
    var bases = document.getElementsByTagName('base');
    exports.baseURI = bases[0] && bases[0].href || window.location.href;
  }
}
else if (typeof location != 'undefined') {
  exports.baseURI = location.href;
}

// sanitize out the hash and querystring
if (exports.baseURI) {
  exports.baseURI = exports.baseURI.split('#')[0].split('?')[0];
  var slashIndex = exports.baseURI.lastIndexOf('/');
  if (slashIndex !== -1)
    exports.baseURI = exports.baseURI.substr(0, slashIndex + 1);
}
else if (typeof process !== 'undefined' && process.cwd) {
  exports.baseURI = 'file://' + (isWindows ? '/' : '') + process.cwd();
  if (isWindows)
    exports.baseURI = exports.baseURI.replace(/\\/g, '/');
}
else {
...
if (exports.baseURI[exports.baseURI.length - 1] !== '/')
  exports.baseURI += '/';
...
RegisterLoader.prototype[RegisterLoader.resolve = Loader.resolve] = function (key, parentKey) {
  return resolveIfNotPlain(key, parentKey || exports.baseURI);
};
...
function NodeESModuleLoader(baseKey, rcPath) {
  ...
  if (baseKey)
    this.baseKey = resolveIfNotPlain(baseKey, exports.baseURI) || resolveIfNotPlain('./' + baseKey, exports.baseURI);
  else
    this.baseKey = exports.baseURI;
...
exports.NodeESModuleLoader = NodeESModuleLoader;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=node-es-module-loader.js.map
