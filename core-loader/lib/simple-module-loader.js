(function (global, factory) {
    ...
    (global.SimpleModuleLoader = factory());
...
class SimpleModuleLoader extends RegisterLoader {
    ...
    config(options) {
        ...
        this.transpilers = [];
        if (options.packages) for (let name of Object.keys(options.packages)) {
            let p = options.packages[name];
